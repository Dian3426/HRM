...
public interface SkdeptMapper {
    ...
    @Select("SELECT d.DEPT_ID,d.NAME DEPTNAME,e.NAME EMPNAME,e.EMP_ID,j.NAME JOBNAME,e.TELE,s.TIME FROM SKEMP e,TALENT t,SKJOB j,SKDEPT d WHERE " +
            "e.EMP_ID=t.EMP_ID AND j.JOB_ID=t.JOB_ID AND j.DEPT_ID=d.DEPT_ID AND d.DEPT_ID=#{dept_id}")
