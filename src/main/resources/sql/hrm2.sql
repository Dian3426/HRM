...
--------------------------------------------------------
  ...
  CREATE TABLE "CHANGE" ("ID" NUMBER(*,0), "EMP_ID" VARCHAR2(10), "OLDDEPT" VARCHAR2(20), "NEWDEPT" VARCHAR2(20), "CHANGREASON" VARCHAR2(20), "OLDJOB" VARCHAR2(20), "NEWJOB" VARCHAR2(20), "TYPE" VARCHAR2(20), "CHANGTIME" VARCHAR2(20))
/
--------------------------------------------------------
--  DDL for Table HISTORY
--------------------------------------------------------

  CREATE TABLE "HISTORY" ("ID" NUMBER(*,0), "DEPT_ID" VARCHAR2(10), "JOB_ID" VARCHAR2(10), "TYPE" VARCHAR2(20), "PEOPLENUM" NUMBER(*,0), "CHANGETIME" VARCHAR2(20), "OLDNUM" NUMBER(*,0), "NEWNUM" NUMBER(*,0), "MANGERNAME" VARCHAR2(20))
/
--------------------------------------------------------
--  DDL for Table LEAVE
--------------------------------------------------------

  CREATE TABLE "LEAVE" ("ID" NUMBER(*,0), "EMP_ID" VARCHAR2(10), "JOB_ID" VARCHAR2(10), "PLACE" VARCHAR2(20), "TIME" VARCHAR2(20), "REASON" VARCHAR2(20))
/
--------------------------------------------------------
--  DDL for Table MANAGER
--------------------------------------------------------

  CREATE TABLE "MANAGER" ("ID" NUMBER(*,0), "NAME" VARCHAR2(20), "PASS" VARCHAR2(32))
/
--------------------------------------------------------
--  DDL for Table OCCUPATIONCAREER
--------------------------------------------------------

  CREATE TABLE "OCCUPATIONCAREER" ("ID" NUMBER(*,0), "BEGINTIME" VARCHAR2(20), "ENDTIME" VARCHAR2(20), "JOBNAME" VARCHAR2(50), "JOBDISCRIP" VARCHAR2(1000), "POSITION" VARCHAR2(100), "SALARY" NUMBER, "REFERENCE" VARCHAR2(100), "REFERENCETEL" VARCHAR2(50), "REFERENCEPOSITION" VARCHAR2(100), "EMP_ID" VARCHAR2(10))
/
--------------------------------------------------------
--  DDL for Table SKDEPT
--------------------------------------------------------

  CREATE TABLE "SKDEPT" ("ID" NUMBER(*,0), "DEPT_ID" VARCHAR2(10), "NAME" VARCHAR2(20), "TYPE" VARCHAR2(20), "TELE" VARCHAR2(20), "FAX" VARCHAR2(20), "DISCRIP" VARCHAR2(50), "SUPERD" VARCHAR2(10), "CREATETIME" VARCHAR2(20))
/
--------------------------------------------------------
--  DDL for Table SKEMP
--------------------------------------------------------

  CREATE TABLE "SKEMP" ("ID" NUMBER(*,0), "EMP_ID" VARCHAR2(10), "NAME" VARCHAR2(50), "SEX" VARCHAR2(10), "BIR" VARCHAR2(20), "IDCARD" VARCHAR2(30), "TOWORKTIME" VARCHAR2(20), "ZZMM" VARCHAR2(20), "NATIONAL" VARCHAR2(20), "NATIV" VARCHAR2(20), "TELE" VARCHAR2(20), "MAIL" VARCHAR2(30), "HEIGHT" VARCHAR2(20), "BLOODTYPE" VARCHAR2(10), "BIRTHPLACE" VARCHAR2(50), "HKPLACE" VARCHAR2(50), "DEGREE" VARCHAR2(20), "GRADUATESCHOOL" VARCHAR2(50), "PROFESSIONAL" VARCHAR2(50), "GRADUATETIME" VARCHAR2(20), "SOURCE" VARCHAR2(20))
/
--------------------------------------------------------
--  DDL for Table SKJOB
--------------------------------------------------------

  CREATE TABLE "SKJOB" ("ID" NUMBER(*,0), "NAME" VARCHAR2(20), "JOB_ID" VARCHAR2(10), "TYPE" VARCHAR2(20), "LIMITNUM" VARCHAR2(10), "DEPT_ID" VARCHAR2(10), "ISLIMIT" VARCHAR2(10))
/
--------------------------------------------------------
--  DDL for Table SKSTAFF
--------------------------------------------------------

  CREATE TABLE "SKSTAFF" ("ID" NUMBER(*,0), "EMP_ID" VARCHAR2(10), "JOB_ID" VARCHAR2(10), "TIME" VARCHAR2(20))
/
--------------------------------------------------------
--  DDL for Table SOCIETYRELATION
--------------------------------------------------------

  CREATE TABLE "SOCIETYRELATION" ("ID" NUMBER(*,0), "RELATION" VARCHAR2(20), "NAME" VARCHAR2(20), "JOB" VARCHAR2(20), "POSI" VARCHAR2(20), "TEL" VARCHAR2(20), "EMP_ID" VARCHAR2(20))
/
--------------------------------------------------------
--  DDL for Table TALENT
--------------------------------------------------------

  CREATE TABLE "TALENT" ("ID" NUMBER(*,0), "EMP_ID" VARCHAR2(10), "JOB_ID" VARCHAR2(10), "STATUS" VARCHAR2(20))
/
--------------------------------------------------------
--  DDL for Table TEMPORARY
--------------------------------------------------------

  CREATE TABLE "TEMPORARY" ("ID" NUMBER(*,0), "EMP_ID" VARCHAR2(10), "JOB_ID" VARCHAR2(10), "BEGINTIME" VARCHAR2(20), "ENDTIME" VARCHAR2(20), "STATUS" VARCHAR2(10))
/
