...
var t = $('#dept_table').DataTable({
    ...
    columnDefs: [{
        ...
        "<button class='btn btn-danger' style='margin-right: 10px;' role='del_btn'>删除</button><button class='btn btn-info' onclick='view_dept_emp()' role='del_btn'>查看员工信息</button>"
    }, {
        searchable: false,
        orderable: false,
        targets: 6,
        data: null,
        defaultContent: "<button class='btn btn-success' role='view_btn' onclick='view_dept_desc()' style='margin-right: 10px;'>查看</button>"
    }
    ],
    order: [[1, 'asc']],
    autoWidth: true
...
function view_dept_emp() {
    ...
    var body = '<table id="dept_emp_table" class="table table-bordered table-striped table-hover" cellspacing="0"><thead><tr><th></th><th>部门编号</th><th>员工姓名</th><th>员工编号</th><th>职务</th><th>联系电话</th><th>岗位编号</th><th>岗位名称</th><th>入职日期</th></tr></thead><tbody></tbody><tfoot><tr><th></th><th>部门编号</th><th>员工姓名</th><th>员工编号</th><th>职务</th><th>联系电话</th><th>岗位编号</th><th>岗位名称</th><th>入职日期</th></tr></tfoot></table>';
    var footer = '<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>';
    showModal(header, body, footer, {}, function () {
