                    ...
                    <table id="emp_add_table" class="table table-bordered table-striped" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td colspan="2" rowspan="3" style=" text-align: center;">
                                <button class="btn btn-primary" id="emp_img_btn">
                                    选择
                                </button>

                                <input accept="image/*" type="file" id="emp_img_input" name="emp_img" style="display: none">
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <div class="td-control">
                                    <input id="emp_former_comp" name="emp_former_comp" type="text" style="width:100%;"
                                           placeholder="所在单位">
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="td-control">
                                    <input id="emp_family_name" name="emp_family_name" type="text" style="width:100%;"
                                           placeholder="姓名">
                                </div>
                            </td>
                            <td colspan="4">
                                <div class="td-control">
                                    <input id="emp_family_comp" name="emp_family_comp" type="text" style="width:100%;"
                                           placeholder="所在单位">
                                </div>
                            </td>
                            <td colspan="2">
