    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <form class="form-horizontal" id="newemp_table_form">
                    <div class="box-body">
                        <span>请输入查询条件：（至少填写一项）</span>

                        <div class="form-group">
                            <label for="search_new_time" class="col-sm-5 control-label">起止时间</label>

                            <div class="input-daterange col-sm-3" id="search_new_time" style="width: 25%;">
                    ...
                    <div class="box-footer">
                        <button type="button" class="btn btn-info pull-right" id="newemp_search_btn">查询</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="row rhide" id="newemp_div">
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    <table class="table table-bordered table-striped table-hover" id="newemp_table_table">
                        <thead>
                        <tr>
                            <th></th>
                            <th>员工编号</th>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/pagejs/newemp_table.js"></script>