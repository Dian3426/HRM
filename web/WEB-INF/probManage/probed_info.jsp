            ...
            <div class="box box-primary">
                ...
                <form class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="emp_dept" class="col-sm-6 control-label">员工部门：</label>
                        ...
                        <div class="form-group">
                            <label for="emp_prob_end" class="col-sm-6 control-label">转正时间：</label>

                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="emp_prob_end" name="emp_prob_end"
                                       placeholder="转正时间">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-footer">
                        <button type="button" class="btn btn-info pull-right" id="probed_search_btn">查询</button>
                    </div>
                </form>
            </div>
        </div>
    </div>
    <div class="row rhide" id="probed_result_div">
        <div class="col-xs-12">
            <div class="box">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/pagejs/probed_info.js"></script>